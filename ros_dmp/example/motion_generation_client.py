...
if __name__ == "__main__":
    ...
    req.dmp_name = "/home/dishuuuuu/Desktop/Advanced Robotics/codes/example.yaml"
    req.tau = 1.0
    req.dt = 0.01
    req.goal_pose = PoseStamped()
    req.goal_pose.header.frame_id = "base_link"
    req.goal_pose.pose.position.x = 1.2
    req.goal_pose.pose.position.y = 1.2
    req.goal_pose.pose.position.z = 0
